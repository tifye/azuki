...
export function RenderComponents(comps: ComponentDefinition[], map: ComponentsMap): JSX.Element {
    return <>
        {comps.map((comp, idx) => RenderComponent(comp, idx, map))}
    </>
}

export function RenderComponent(comp: ComponentDefinition, key: any, map: ComponentsMap): JSX.Element {
    console.debug(comp)
